...
namespace QuantumTek.QuantumDialogue
{
    ...
    public class QD_Dialogue : ScriptableObject
    {
        ...
        public List<QD_Variable> Variables = new List<QD_Variable>();
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public QD_Variable GetVariable(int id)
        {
        ...
        /// <summary>
        /// Sets a variable with the given id.
        /// </summary>
        /// <param name="id"></param>
        /// <param name="variable"></param>
        /// <returns></returns>
        public void SetVariable(int id, QD_Variable variable)
        {
            Variables[GetVariableIndex(id)] = variable;
        }
    }
}